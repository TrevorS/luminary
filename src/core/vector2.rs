...
impl<T: Real> Index<usize> for Vector2<T> {
    type Output = T;
...
impl<T: Real> IndexMut<usize> for Vector2<T> {
...
impl<T: Real + AddAssign> AddAssign for Vector2<T> {
...
impl<T: Real + SubAssign> SubAssign for Vector2<T> {
...
impl<T: Real + MulAssign> MulAssign<T> for Vector2<T> {
...
impl<T: Real + MulAssign> DivAssign<T> for Vector2<T> {
